		...
		Object.defineProperty(stream, "write", {
			...
			get:
				...
				(
					...
					// Fix type incompatibility: callback may expect (err?: Error | null | undefined)
					// but our callback is (err?: Error | undefined). Wrap to allow null.
					original.call(
						stream,
						chunk,
						encoding,
						callback
							? (err?: Error | null) => {
									// Forward as (err?: Error | undefined)
									callback(err === null ? undefined : err);
								}
							: undefined,
					);
				},
